jQuery(document).ready(function () {
    ...
    jQuery.getJSON('http://cdn.gdnonline.com/classifieds/' + querystring('id') + '?jsoncallback=?', function (data) {
        jQuery.each(data, function (key, value) {
            ...
            contenthtml += ' <div class="ttitle oswald"  onclick="javascript:window.location.href=\'classdetails.html?orderid=' + data[key].OrderID + '&adserialno=' + data[key].adserialno + ' \'"   >' + data[key].Text + '';
